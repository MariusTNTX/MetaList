...
let loginForm = `
  ...
  <form action="" method="get" class="dropdown-menu dropdown-menu-end p-4 w-50" id="loginForm">
    ...
    <div class="mb-3 text-center">
      <a href="emailForm.php" id="forgPass">He olvidado mi contraseña</a>
    </div>
    <hr class="mt-4">
...
//Eliminado de PHPSESSID en Index
if(!window.location.href.includes('emailForm.php') && 
   !window.location.href.includes('emailConfirm.php') && 
   !window.location.href.includes('passInstructions.php')){
    document.cookie="PHPSESSID=0; expires="+new Date(0).toUTCString();
} 
