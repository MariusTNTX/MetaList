...
botonVerificar1.addEventListener("click", async (e)=>{
  e.preventDefault();
...
verificarCuenta.addEventListener("click", async (e)=>{
  e.preventDefault();
...
async function addUser(){
  ...
  //Se incluye el usuario si no existe en la base de datos
  let data = await list("usuarios",true,["emailUsuario",correo.value]);
  ...
  } else showAlert("ERROR","Error al registrar. La cuenta de usuario ya existe");
}
