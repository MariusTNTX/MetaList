...
let titleLeftElm = document.getElementById("titleLeft");
let titleCenterElm = document.getElementById("titleCenter");
...
function head(elm, data){
  if(elm=='album'){
    ...
    if(titleLeftElm) titleLeftElm.classList.add("d-none");
    titleCenterElm.classList.remove("col-sm-8");
    titleCenterElm.classList.replace("col-6","col-12");
  }
