...
let campos = {
  ...
  estrellasCancion: {type: "interval", name: "Estrellas de Canción", reqName: "estrellasCancion", min: 0, max: 3, sufix: "", step: 1},
  ...
  anioInicioEtapaMusico: {type: "interval", name: "Año de Inicio de Músico en una Banda", reqName: "anioInicioEtapaMusico", min: 1960, max: new Date().getFullYear(), sufix: "", step: 1},
  anioFinEtapaMusico: {type: "interval", name: "Año de Fin de Músico en una Banda", reqName: "anioFinEtapaMusico", min: 1960, max: new Date().getFullYear(), sufix: "", step: 1},
  ...
  puntuacionAlbum: {type: "interval", name: "Puntuación de álbum", reqName: "puntuacionAlbum", min: 0, max: 120000, sufix: "P", step: 500},
  ...
  puntuacionBanda: {type: "interval", name: "Puntuación de Banda", reqName: "puntuacionBanda", min: 0, max: 15000, sufix: "P", step: 100},
  ...
  puntuacionDiscografica: {type: "interval", name: "Puntuación de Discográfica", reqName: "puntuacionDiscografica", min: 0, max: 700000, sufix: "P", step: 1000},
  ...
  puntuacionMusico: {type: "interval", name: "Puntuación de Músico", reqName: "puntuacionMusico", min: 0, max: 1000000, sufix: "P", step: 1000},
...
let metadata = {
  albums: {
    ...
    checks: [],
    intervals: [campos.anioAlbum, campos.puntuacionAlbum, campos.escuchasAlbum, campos.visitasBanda, campos.visitasAlbum,
                campos.estrellasMaximasAlbum, 
  ...
  bands: {
    ...
    checks: [],
    intervals: [campos.escuchasBanda, campos.visitasBanda, campos.anioAlbum,
                campos.estrellasMaximasBanda, campos.puntuacionBanda, campos.numeroAlbumesBanda, 
    ...
    categories: [campos.paisBanda,campos.estatusBanda,campos.nombreGeneroBanda],
    reductions: [campos.nombreAlbum,campos.nombreDiscografica,campos.nombreEstudioAlbum,campos.nombreMusicoEtapa,
