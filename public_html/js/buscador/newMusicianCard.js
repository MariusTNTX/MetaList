async function getMusicianCard(musician){
  ...
  txt += `<div class="accordion accordion-flush mt-3" id="accordion${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
            <div class="accordion-item shadow-sm">
              <h2 class="accordion-header" id="flush-headingRoles${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseRoles${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}" aria-expanded="false" aria-controls="flush-collapseRoles${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
                  Roles
                </button>
              </h2>
              <div id="flush-collapseRoles${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}" class="accordion-collapse collapse" aria-labelledby="flush-headingRoles${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}" data-bs-parent="#accordion${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
            ...
            <div class="accordion-item shadow-sm">
              <h2 class="accordion-header" id="flush-heading${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}" aria-expanded="false" aria-controls="flush-collapse${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
                  Más Estadísticas
                </button>
              </h2>
              <div id="flush-collapse${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}" class="accordion-collapse collapse" aria-labelledby="flush-heading${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}" data-bs-parent="#accordion${musician.puntuacion+musician.musico.replace(/[^a-zA-Z0-9]+/g, '-').toLowerCase()}">
                <div class="row justify-content-center accordion-body stats">
                  <div class="col-auto text-start">
