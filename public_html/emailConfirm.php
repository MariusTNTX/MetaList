      ...
      <div class="container" data-aos="fade-up">
        <div class="reg-container row justify-content-center" data-aos="fade-up" data-aos-delay="100">
          ...
          <form action="passInstructions.php" method="get" enctype="multipart/form-data" id="regForm" class="php-email-form col-10 col-md-8 col-lg-6 col-xl-5 px-4 py-5 rounded-3 shadow-lg">
            ...
            <!-- Correo -->
            <div class="row mb-2">
                <p class="text-center">¿Deseas sustituir tu contraseña actual por la nueva contraseña que recibirás al email indicado (<b><?php echo $_SESSION['correo']?></b>)?</p>
            </div>
            
            <!-- Botón Crear cuenta -->
            <div class="row mb-4">
              <div class="col-12 text-center more">
                <button type="submit" name="send" id="botonVerificar1" class="btn" value="true">Conseguir mi nueva contraseña</button>
              </div>
            </div>
            ...
            <div class="row mb-1">
              <div class="col-12">
                <p class="text-center"><a href="emailForm.php">Volver a la página anterior</a></p>
              </div>
            </div>
            ...
            <div class="row mb-2">
              <div class="col-12">
                <p class="text-center"><a href="index.html">Regresar a la página inicial</a></p>
              </div>
            </div>
