    ...
    <section class="inner-page">
      <div class="container" data-aos="fade-up">
        <div class="reg-container row justify-content-center" data-aos="fade-up" data-aos-delay="100">
          ...
          <!-- CONTENEDOR -->
          <form action="emailConfirm.php" method="get" enctype="multipart/form-data" id="regForm" class="php-email-form col-10 col-md-8 col-lg-6 col-xl-5 px-4 py-5 rounded-3 shadow-lg">

            <!-- Correo -->
            <div class="row mb-2">
                <p class="text-center">Para poder acceder a tu cuenta debes recibir tu nueva contraseña provisional. Indica tu dirección de correo electrónico:</p>
            </div>
            <div class="row mb-4">
              <div class="col-12">
                <div class="form-floating">
                  <input type="email" class="form-control" name="correo" id="correo" placeholder="Correo Electrónico" value="<?php if(isset($_SESSION['correo'])) echo $_SESSION['correo']?>" required>
                  <label for="correo">Correo Electrónico <span>*</span></label>
                  <div class="form-text text-black-50 fst-italic ms-2">Por ejemplo: Janedoe19@gmail.com</div>
                  <div id="validacionCorreo" class="invalid-feedback ms-2">
                    <span class="valCorreo d-none" id="valCorreo1">Debes indicar una dirección de correo electrónico</span>
                    <span class="valCorreo d-none" id="valCorreo2">Indica un correo válido como el que se indica en el ejemplo</span>
                    <span class="valCorreo d-none" id="valCorreo3">Éste correo ya se encuentra registrado, debes indicar otro</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row mb-4">
              <div class="col-12 text-center more">
                <button type="submit" id="botonVerificar1" class="btn">Continuar</button>
              </div>
            </div>
            ...
            <div class="row mb-2">
              <div class="col-12">
                <p class="text-center"><a href="index.html" id="toLoginForm">Regresar a la página inicial</a></p>
              </div>
            </div>
