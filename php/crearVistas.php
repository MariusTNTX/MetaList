<?php
  mysqli_query($c1,"CREATE OR REPLACE VIEW albumes_plus AS 
  SELECT a.NomBan, a.NomAlb, a.Descrip, a.Imagen, a.TipoAlb, a.EnLista, a.Anio, a.Mes, a.Dia, a.NumEscuchasMax, a.LinkSpotify, a.LinkAmazon, a.Duracion, a.Visitas,
    ...
    ROUND(SQRT(a.NumEscuchasMax+a.NumEscuchasMax*(SELECT distinct MAX(Estrellas)*MAX(Estrellas) FROM generos_albumes where NomBan = a.NomBan and NomAlb = a.NomAlb)),0) as Puntuacion,
  ...
  mysqli_query($c1,"CREATE OR REPLACE VIEW bandas_plus AS 
    SELECT b.NomBan, b.Pais, b.Origen, b.NumEscuchasMes, b.Imagen, b.Estatus, b.Descrip, b.LinkWeb, b.LinkSpotify, b.FechaIncorp, b.Visitas,
      ...
      ROUND(SQRT(b.NumEscuchasMes+b.NumEscuchasMes*(SELECT DISTINCT MAX(Estrellas)*MAX(Estrellas) FROM generos_bandas where NomBan = b.NomBan)),0) as Puntuacion,
  ...
  mysqli_query($c1,"CREATE OR REPLACE VIEW discograficas_plus AS 
  ...
  mysqli_query($c1,"CREATE OR REPLACE VIEW musicos_plus AS 
