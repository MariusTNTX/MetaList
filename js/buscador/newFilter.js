...
let metadata = {
  albums: {
    ...
    intervals: [campos.anioAlbum, campos.puntuacionAlbum, campos.escuchasAlbum, campos.visitasAlbum, campos.visitasBanda, /* campos.duracionAlbum, */ 
                campos.estrellasCancion, campos.estrellasGeneroAlbum, campos.estrellasGeneroBanda, campos.estrellasMaximasAlbum, 
  ...
  bands: {
    ...
    categories: [campos.paisBanda,campos.estatusBanda,campos.nombreGeneroAlbum,campos.nombreGeneroBanda],
